...
model_setings=ModelSettings(target_budget= 5_000_000_000,
                            min_margin=0.20,
                            weight_budget=0.5,
                            weight_health=0.3,
                            weight_quality=0.2
                            )
engine =ScoringEngine(settings=model_setings)

result =engine.evaluate(n,companies)

print("Score budget:", result.score_budget)
print("Score health:", result.score_health)
print("Score quality:", result.score_quality)
print("Score total:", result.score_total)
